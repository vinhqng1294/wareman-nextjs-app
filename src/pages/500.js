...
const Page500Wrapper = styled.div`
  .main-error-page {
    min-height: 100vh;
    margin: 0px auto;
    width: auto;
...
const Custom500Page = function ({ ...props }) {
  return (
    <React.Fragment>
      <Page500Wrapper>
        <div className='main-error-page xxs:px-3 md:px-0'>
          <svg
          ...
          <p className='error-title xxs:text-xl md:text-4xl text-center font-bold'>
            {/* Woops! <br /> */}

...
const InputPassword = function ({
  ...
  const [passwordState, setPasswordState] = useState(PasswordState.hide);
  const [passwordVal, setPasswordVal] = useState('');

  const passwordCheckboxOnChange = function ({ checked }) {
    if (checked === true) {
      setPasswordState(PasswordState.show);
    } else {
      setPasswordState(PasswordState.hide);
    }
  };

  const passwordOnChange = function (evt) {
        ...
        <div className='flex flex-col'>
            ...
            <React.Fragment>
              <div
                className={'items-center justify-center h-full'
                  ...
                  .concat(
                    inputState === InputState.danger ? ' flex' : ' hidden'
                  )
                  .concat(
                ...
                >
                  <ReactSVG
                    ...
                    className={''
                      ...
                      .concat(
                        inputStateIconSize ? ` ${inputStateIconSize}` : ''
                      )}
                  />
                </button>
              </div>
          ...
          <div className={'mt-2 flex pl-1'}>
            <Checkbox
              ...
              onChange={passwordCheckboxOnChange}
              checked={passwordState.checked}
            />
          </div>
        </div>
      </div>

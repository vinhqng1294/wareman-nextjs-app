import { getProductImportData } from '@/apis/report.api';
...
const ProductImportChart = function ({
  setErrorMsg,
  setViewErrorPopup,
  viewErrorPopup,
  accessToken,
      ...
      if (stringIsNotEmpty(submitData?.productId)) {
        ...
        getProductImportData({
          ...
          .then(function ({ data: resData }) {
            console.info('getProductImportData resData', resData);
  ...
  return (
    <React.Fragment>
      {loading ? (
        ...
        <React.Fragment>
          <LineChart
            chartTitle={`Số lượng sản phẩm nhập kho từ ngày ${reportDate?.startDate} đến ngày ${reportDate?.endDate}`}
...
export default ProductImportChart;

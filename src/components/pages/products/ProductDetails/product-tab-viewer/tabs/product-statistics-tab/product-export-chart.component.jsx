import { getProductExportData, getProductImportData } from '@/apis/report.api';
...
const ProductExportChart = function ({
  setErrorMsg,
  setViewErrorPopup,
  viewErrorPopup,
  accessToken,
      ...
      if (stringIsNotEmpty(submitData?.productId)) {
        ...
        getProductExportData({
          ...
          .then(function ({ data: resData }) {
            console.info('getProductExportData resData', resData);
  ...
  return (
    <React.Fragment>
      {loading ? (
        ...
        <React.Fragment>
          <LineChart
            chartTitle={`Số lượng sản phẩm xuất kho từ ngày ${reportDate?.startDate} đến ngày ${reportDate?.endDate}`}
...
export default ProductExportChart;

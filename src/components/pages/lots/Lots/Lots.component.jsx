...
import LotFilter from './lot-filter.component';
    ...
    function () {
      if (arrayIsNotEmpty(userPermissions)) {
        ...
        const result = checkPermission({
          permissionKey: PermissionList.CREATE_LOT.key,
          ...
          {pageLoading ? (
            ...
            <React.Fragment>
              ...
              >
                ...
                >
                  <SearchBarType1 placeholder={'Tìm kiếm phân khu'} />
                  <LotFilter />
                </div> */}

...
import { getWarehouseExportRequestStatusLogs } from '@/apis/warehouse-export-request.api';
  ...
  useEffect(
    function () {
      if (stringIsNotEmpty(requestId)) {
        setLoading(true);
        getWarehouseExportRequestStatusLogs({
          accessToken: accessToken,
          requestId: requestId,
        })
          .then(function ({ data: resData }) {
            console.info(
              'getWarehouseExportRequestStatusLogs resData',
              resData
            );

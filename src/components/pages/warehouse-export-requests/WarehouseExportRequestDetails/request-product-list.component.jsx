import { getWarehouseExportRequestProducts } from '@/apis/warehouse-export-request.api';
import {
  ButtonType,
  ...
  useEffect(
    function () {
      if (objectIsNotEmpty(requestInfo)) {
        ...
        getWarehouseExportRequestProducts({
          accessToken,
          ...
          .then(function ({ data: resData }) {
            console.info('getWarehouseExportRequestProducts resData', resData);
            ...
            <div className='flex ml-auto'>
              <button
                ...
                onClick={function (evt) {
                  evt?.preventDefault();
                  evt?.stopPropagation();
                  if (isFunction(handleViewProductExportDetailsModal)) {
                    handleViewProductExportDetailsModal({});
                  }
                }}
              >

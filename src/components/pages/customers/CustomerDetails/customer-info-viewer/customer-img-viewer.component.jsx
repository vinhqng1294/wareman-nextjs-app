...
import CustomerImg from './customer-img.component';

const CustomerImgViewer = function ({ photoList, ...props }) {
          ...
          <CustomerImg
            imgUrl={
              stringIsNotEmpty(selectedImgId)
                ? `${process.env.NEXT_PUBLIC_API_DOMAIN}/photos/provider/download/url?id=${selectedImgId}`
                : ''
            }
          />
        </div>
                      ...
                      <React.Fragment key={index}>
                        ...
                        >
                          <CustomerImg
                            ...
                            imgUrl={`${process.env.NEXT_PUBLIC_API_DOMAIN}/photos/provider/download/url?id=${photoId}`}
                          />
                        </div>
                      </React.Fragment>
                    );
...
export default CustomerImgViewer;

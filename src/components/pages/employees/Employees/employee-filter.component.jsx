...
const EmployeeFilter = function ({ ...props }) {
              ...
              label={function ({ ...props }) {
                return (
                  <p className='text-sm leading-4 text-dark space-x-1'>
                    ...
                    <span className='text-amber-500'>Đang liên hệ</span>
                  </p>
                );
              }}
            />
            ...
            <Checkbox
              ...
              label={function ({ ...props }) {
                return (
                  <p className='text-sm leading-4 text-dark space-x-1'>
                    {/* <span>Agree with dasd sad ada asd asdasd ada ad ad</span> */}
                    <span className='text-green-500'>Đã ký kết</span>
                  </p>
                );
              }}
            />
            ...
            <Checkbox
              ...
              label={function ({ ...props }) {
                return (
                  <p className='text-sm leading-4 text-dark space-x-1'>
                    {/* <span>Agree with dasd sad ada asd asdasd ada ad ad</span> */}
                    <span className='text-red-500'>{'Ký kết > 1 năm'}</span>
                  </p>
                );
              }}
            />
            ...
            <Checkbox
              ...
              label={function ({ ...props }) {
                return (
                  <p className='text-sm leading-4 text-dark space-x-1'>
                    {/* <span>Agree with dasd sad ada asd asdasd ada ad ad</span> */}
                    <span className='text-zinc-500'>{'Ký kết > 5 năm'}</span>
                  </p>
                );
              }}
            />

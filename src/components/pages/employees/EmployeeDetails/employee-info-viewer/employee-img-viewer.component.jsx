...
import EmployeeImg from './employee-img.component';

const EmployeeImgViewer = function ({ itemData, ...props }) {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        >
          <EmployeeImg imgUrl={itemData?.imgUrl} />
        </div>
        <div
          ...
          >
            <div className='flex flex-col space-y-5'>
              {/* <div className='w-36 h-36'>
                <EmployeeImg defaultSvgSize={'w-14 h-14'} />
              </div>
              <div className='w-36 h-36'>
                <EmployeeImg defaultSvgSize={'w-14 h-14'} />
              </div>
...
export default EmployeeImgViewer;

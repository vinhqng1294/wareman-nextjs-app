...
import ProviderFilter from './provider-filter.component';
...
const ProvidersMain = function ({ ...props }) {
          ...
          {pageLoading ? (
            ...
            <React.Fragment>
              ...
              >
                ...
                >
                  <SearchBarType1 placeholder='Tìm kiếm nhà cung cấp' />
                  <ProviderFilter />
                </div> */}

...
const DataInputSection = function ({
  ...
  console.info('DataInputSection defaultValue', defaultValue);
  ...
  const [defaultSourceUomValue, setDefaultSourceUomValue] = useState('');
  ...
  useEffect(
    function () {
      if (arrayIsNotEmpty(uomOptions)) {
        const foundUom = [...uomOptions].find(function (uomData, index) {
          if (uomData?.value?.id === inputData?.sourceUomId) {
            return uomData;
          }
        });
        console.info('foundUom', foundUom);
        if (foundUom) {
          setDefaultSourceUomValue(foundUom);
          setSelectedSourceUomData(foundUom?.value);
        }
      }
    },
    [uomOptions]
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex w-72'>
              <InputSelect
                ...
                options={uomOptions}
                defaultValue={defaultSourceUomValue}
              />
            </div>
            {!inputValidation?.sourceUomId &&
              ...
              <div className='flex flex-col'>
                ...
                <div className='flex flex-none items-center space-x-3'>
                  <CounterInput
                    ...
                    isFloat={productInfoData?.data?.productUomIsFloat}
                    fractionDigits={3}
                    inputWidth={'w-56'}
                    valueOnChange={destQuantityOnChange}
                  />
                  <p className='text-base text-dark font-medium'>
                    {productInfoData?.data?.productUomName}
                  </p>
                </div>

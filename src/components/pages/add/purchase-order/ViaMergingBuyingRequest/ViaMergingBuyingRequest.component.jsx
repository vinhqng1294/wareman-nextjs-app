...
import SelectBuyingRequestsForm from './select-buying-requests-form/select-buying-requests-form.component';
...
const ViaMergingBuyingRequestMain = function ({ ...props }) {
  ...
  const addProductSteps = {
    ...
    2: {
      ...
      subTitle:
        'Vui lòng chọn những yêu cầu mua hàng mà bạn cần, để tạo đơn đặt hàng',
    },
    3: {
      title: 'Chọn sản phẩm',
  ...
  const updateBuyingRequestInfoList = function ({ data, ...props }) {
    setBuyingRequestInfoList(data);
  };
  const [selectedBuyingRequestCount, setSelectedBuyingRequestCount] =
    useState(0);
  console.info('buyingRequestInfoList', buyingRequestInfoList);
  console.info('selectedBuyingRequestCount', selectedBuyingRequestCount);
              ...
              >
                ...
                {currStep === 2 && (
                  <SelectBuyingRequestsForm
                    ...
                    defaultBuyingRequestInfoList={buyingRequestInfoList}
                    updateBuyingRequestInfoList={updateBuyingRequestInfoList}
                    defaultSelectedCount={selectedBuyingRequestCount}
                    updateDefaultSelectedCount={setSelectedBuyingRequestCount}
                  />
                )}
                  ...
                  <ProductItemForm
                    ...
                    defaultValue={
                      [...finalData?.products].find(function (item) {
                        if (
                          item?.productId ===
                          selectedProductItemData?.data?.productId
                        ) {
                          return item;
                        }
                      }) ?? {
...
export default ViaMergingBuyingRequestMain;

...
const BuyingRequestsMain = function ({ ...props }) {
          ...
          {pageLoading ? (
            ...
            <React.Fragment>
              ...
              >
                ...
                >
                  <SearchBarType1 placeholder={'Tìm kiếm yêu cầu mua hàng'} />
                  <BuyingRequestFilter />
                </div> */}
...
export default BuyingRequestsMain;

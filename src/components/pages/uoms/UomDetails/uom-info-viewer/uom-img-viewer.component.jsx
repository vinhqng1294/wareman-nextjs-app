...
import UomImg from './uom-img.component';

const UomImgViewer = function ({ itemData, ...props }) {
          ...
          >
            <div className='flex flex-col space-y-5'>
              <div className='w-36 h-36'>
                <UomImg defaultSvgSize={'w-14 h-14'} />
              </div>
              <div className='w-36 h-36'>
                <UomImg defaultSvgSize={'w-14 h-14'} />
              </div>

...
import UomFilter from './uom-filter.component';
import UomItemList from './uom-item-list.component';
              ...
              >
                ...
                {/* <div
                  className={'flex flex-col'
                    ...
                    .concat(' w-full max-w-2xl')}
                >
                  <SearchBarType1 placeholder='Tìm kiếm đơn vị đo' />
                  <UomFilter />
                </div> */}

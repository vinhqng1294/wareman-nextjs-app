import { getPurchaseOrderProducts } from '@/apis/purchase-order.api';
import {
  ButtonType,
...
import ProductItem from './purchase-order-product-item.component';

const PurchaseOrderProductList = function ({
  purchaseOrderInfo,
  accessToken,
  setErrorMsg,
  setViewErrorPopup,

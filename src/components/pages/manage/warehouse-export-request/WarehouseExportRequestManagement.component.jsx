...
const WarehouseExportRequestManagementMain = function ({ ...props }) {
  ...
  useEffect(
    function () {
      if (!stringIsNotEmpty(auth?.accessToken)) {
        ...
        redirectTo('/warehouse-export-requests');
      }
    },
    [auth?.accessToken]
  );
      ...
      >
        <ContentContainer cssClassnames={'xxs:px-2 md:px-5'}>
          ...
          >
            ...
            >
              <FunctionItem
                itemName={'Xem tất cả yêu cầu xuất kho'}
...
export default WarehouseExportRequestManagementMain;

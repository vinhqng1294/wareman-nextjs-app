...
const PurchaseOrderManagementMain = function ({ ...props }) {
      ...
      >
        <ContentContainer cssClassnames={'xxs:px-2 md:px-5'}>
          ...
          >
            ...
            >
              <FunctionItem
                itemName={'Xem tất cả đơn đặt hàng'}
                url={'/purchase-orders'}
              />
              {permissionList?.createPurchaseOrder && (
                <React.Fragment>
                  <FunctionItem
...
export default PurchaseOrderManagementMain;

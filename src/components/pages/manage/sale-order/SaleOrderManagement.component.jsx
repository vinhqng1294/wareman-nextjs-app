...
const SaleOrderManagementMain = function ({ ...props }) {
      ...
      >
        <ContentContainer cssClassnames={'xxs:px-2 md:px-5'}>
          ...
          >
            ...
            >
              <FunctionItem
                itemName={'Xem tất cả đơn bán hàng'}
                url={'/sale-orders'}
              />
              {permissionList?.createSaleOrder && (
                <React.Fragment>
                  <FunctionItem
                    itemName={'Tạo đơn bán hàng'}
                    url={'/add/sale-order'}
                  />
                </React.Fragment>
              )}
...
export default SaleOrderManagementMain;

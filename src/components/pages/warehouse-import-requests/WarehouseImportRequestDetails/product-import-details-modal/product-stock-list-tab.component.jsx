...
import { getProductStockImportByImportId } from '@/apis/product-stock.api';
  ...
  useEffect(
    function () {
      if (stringIsNotEmpty(requestId)) {
        setLoading(true);
        getProductStockImportByImportId({
          ...
          .then(function ({ data: resData }) {
            console.info('getProductStockImportByImportId resData', resData);
      ...
      >
        ...
        <div
          className={'flex w-44 flex-none'
            ...
            .concat(' px-2 py-1.5')}
        >
          <p className='text-base text-dark font-semibold'>Mã đơn xuất hàng</p>
        </div>
        <div

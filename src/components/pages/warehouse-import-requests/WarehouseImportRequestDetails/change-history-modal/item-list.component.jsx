...
import { getWarehouseImportRequestStatusLogs } from '@/apis/warehouse-import-request.api';
  ...
  useEffect(
    function () {
      if (stringIsNotEmpty(requestId)) {
        setLoading(true);
        getWarehouseImportRequestStatusLogs({
          accessToken: accessToken,
          requestId: requestId,
        })
          .then(function ({ data: resData }) {
            console.info(
              'getWarehouseImportRequestStatusLogs resData',
              resData
            );

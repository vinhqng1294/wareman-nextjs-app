...
import RoleItemList from './role-item-list.component';
...
const RolesMain = function ({ ...props }) {
    ...
    function () {
      if (arrayIsNotEmpty(userPermissions)) {
        ...
        const result = checkPermission({
          permissionKey: PermissionList.CREATE_ROLE.key,
              ...
              >
                ...
                {/* <div
                  className={'flex flex-col'
                    ...
                    .concat(' w-full max-w-2xl')}
                >
                  <SearchBarType1 placeholder='Tìm kiếm chức vụ' />
                  <RoleFilter />
                </div> */}

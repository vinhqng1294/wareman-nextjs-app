import { getSaleOrderProducts } from '@/apis/sale-order.api';
import {
  ButtonType,
...
import ProductItem from './sale-order-product-item.component';

const SaleOrderProductList = function ({
  saleOrderInfo,
  accessToken,
  setErrorMsg,
  setViewErrorPopup,
  ...
  // const [groupProductListByCustomer, setGroupProductListByCustomer] = useState(
  //   {}
  // );
  // useEffect(
  //   function () {
  ...
  //         isArray(temp[product?.customer?.id])
  //           ? temp[product?.customer?.id].push(product)
  //           : (temp[product?.customer?.id] = [product]);
  //       });
  //       setGroupProductListByCustomer({
  //         ...groupProductListByCustomer,
  //         ...temp,
  //       });
  //     }
  //   },
...
export default SaleOrderProductList;
